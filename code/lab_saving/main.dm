...
/mob/Write(savefile/F)
	if(F.name == "saves/players/[src.ckey].sav")
		..(F)
...
/obj/signal/wire/Write(savefile/F)
	var/obj/signal/wire/old_line1
	var/obj/signal/wire/old_line2
...
/obj/signal/wire/Read(savefile/F)
	..()
	spawn(1)
		if(w_color)
			switch(w_color)
...
/area/save_location/proc/Load(mob/caller)
...
/mob/labcontrol/proc/ClearAllWires()
...
/mob/labcontrol/proc/ClearUnlabeledWires()
...
/mob/labcontrol/proc/ClearWiresByLabel()
