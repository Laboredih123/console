...
/obj/signal/switchboard/proc/ret_line(S as obj in view(usr.client))
	if (src.line1 == S)
		return "line1"
	if (src.line2 == S)
		return "line2"
...
/obj/signal/switchboard/process_signal(obj/signal/S, obj/source)
	..()
	if(isnull(S))return
...
/obj/signal/switchboard/proc/ret_str(obj/signal/S as obj in view(usr.client))
	if (S.cur_file)
...
/obj/signal/switchboard/verb/disconnect()
	set src in oview(1)
